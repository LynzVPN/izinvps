...
Exp=$(curl -sS https://raw.githubusercontent.com/LynzVPN/izinvps/ipuk/ip | grep $MYIP | awk '{print $3}')
fi
...
exp=$( curl -s https://raw.githubusercontent.com/LynzVPN/izinvps/ipuk/ip | grep -w $IP | cut -d ' ' -f 3 )
